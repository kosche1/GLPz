        ...
        <aside class="fixed left-0 top-0 h-screen w-64 bg-black/30 backdrop-blur-md pt-20 border-r border-white/10">
            <div class="flex flex-col h-full p-4">
                ...
                <nav class="space-y-1 flex-grow">
                    ...
                    <a href="{{ route('superadmin.levels.index') }}" class="flex items-center space-x-3 text-white hover:bg-white/10 rounded-lg p-3 transition-colors">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <a href="{{ route('superadmin.achievements.index') }}" class="flex items-center space-x-3 text-white hover:bg-white/10 rounded-lg p-3 transition-colors">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">

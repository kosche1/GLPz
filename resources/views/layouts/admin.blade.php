        ...
        <aside class="fixed left-0 top-0 h-screen w-64 bg-black/30 backdrop-blur-md pt-20 border-r border-white/10">
            <div class="flex flex-col h-full p-4">
                ...
                <div class="text-center mb-4">
                    ...
                    <h2 class="text-lg font-semibold text-white">Administrator</h2>
                    <p class="text-sm text-white/60">School Management</p>
                </div>

                <!-- Navigation -->
                <nav class="space-y-1 flex-grow">
                    <a href="{{ route('admin.dashboard') }}" class="flex items-center space-x-3 text-white hover:bg-white/10 rounded-lg p-3 transition-colors">
